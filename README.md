# Bash Docker Validator

A set of bash functions to validate Docker stuff...
...
Check [Milestones](https://gitlab.com/exadra37-bash/docker-validator/milestones) to see what Goals I want to achieve.

Watch [Boards](https://gitlab.com/exadra37-bash/docker-validator/boards) to keep track of what is going on.
